...
class CandidaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidatura" do
    assert_difference("Candidatura.count") do
      post candidaturas_url, params: { candidatura: { candidato_id: @candidatura.candidato_id, empregador_id: @candidatura.empregador_id, msg: @candidatura.msg, status: @candidatura.status, vaga_id: @candidatura.vaga_id } }
    end
  ...
  test "should update candidatura" do
    patch candidatura_url(@candidatura), params: { candidatura: { candidato_id: @candidatura.candidato_id, empregador_id: @candidatura.empregador_id, msg: @candidatura.msg, status: @candidatura.status, vaga_id: @candidatura.vaga_id } }
